!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "e7f00b7e-6e46-4487-939e-0acdfde4fbb0"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-e7f00b7e-6e46-4487-939e-0acdfde4fbb0"));
  } catch (e) {}
})(),
        ...
        let C = u.default.forwardRef(function (e, t) {
          ...
          let x = u.default.useContext(s.RouterContext),
            ...
            { href: D, as: K } = u.default.useMemo(() => {
              ...
              return { href: e, as: _ ? (0, l.resolveHref)(x, _) : t || e };
            }, [x, a, _]),
          ...
          let V = k ? r && "object" == typeof r && r.ref : t,
            ...
            G = u.default.useCallback(
              (e) => {
                (H.current !== K || F.current !== D) &&
                  (B(), (H.current = K), (F.current = D)),
                  q(e),
                  V &&
                    ("function" == typeof V
                      ? V(e)
          ...
          u.default.useEffect(() => {
            S && z && N && v(S, D, K, { locale: I }, { kind: U }, w);
          ...
          if ((0, i.isAbsoluteUrl)(K)) Y.href = K;
            ...
            Y.href =
              t ||
              (0, y.addBasePath)(
                (0, c.addLocale)(K, e, null == x ? void 0 : x.defaultLocale)
              );
          }
          return k
            ? u.default.cloneElement(r, Y)
            : (0, o.jsx)("a", { ...A, ...Y, children: n });
        });
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
