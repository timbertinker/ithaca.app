!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "5656b2be-c241-46ff-9e06-bb91818efc15"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-5656b2be-c241-46ff-9e06-bb91818efc15"));
  } catch (e) {}
})(),
      ...
      94864: function (e, t, s) {
        ...
        t.default = () => {
          let [e, t] = (0, i.useState)(!0),
            { storiesTab: s, setStoriesTab: m } = (0, p.xc)(),
            x = (0, i.useMemo)(() => d.he, []),
            w = (0, i.useMemo)(() => {
              let e = x.find((e) => e.id === s);
              return null != e ? e : x[0];
            }, [x, s]);
