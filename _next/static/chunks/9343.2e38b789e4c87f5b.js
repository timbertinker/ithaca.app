!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "57c9e4e8-0427-4458-a8a0-1c8f9e4e058c"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-57c9e4e8-0427-4458-a8a0-1c8f9e4e058c"));
  } catch (e) {}
})();
("use strict");
  ...
  [9343],
  {
    75740: function (e, t, s) {
      ...
      async function U(e, t) {
        let s = k({ sdkType: "wcm", sdkVersion: D }, t),
          r = new URL(e, M);
        return (
      ...
      let P = {
        ...
        getWalletImageUrl: (e) =>
          `${M}/w3m/v1/getWalletImage/${e}?projectId=${O.state.projectId}&sdkType=wcm&sdkVersion=${D}`,
        getAssetImageUrl: (e) =>
          `${M}/w3m/v1/getAssetImage/${e}?projectId=${O.state.projectId}&sdkType=wcm&sdkVersion=${D}`,
      };
      var S = Object.defineProperty,
        ...
        R = (e, t) => {
          ...
          if (N) for (var s of N(t)) _.call(t, s) && x(e, s, t[s]);
          return e;
        };
      let $ = b.isMobile(),
        V = f({
          ...
          async getRecomendedWallets() {
            ...
            if (b.isArray(e)) {
              ...
              let { chains: e, isAuth: s } = I.state,
                ...
                { listings: a } = $
                  ? await P.getMobileListings(o)
                  : await P.getDesktopListings(o);
