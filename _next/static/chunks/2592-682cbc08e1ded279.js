!(function () {
  try {
    ...
    e &&
      ...
      (t._sentryDebugIds[e] = "379053b2-fb33-4a5f-b3d3-dda3ec1dc674"),
      (t._sentryDebugIdIdentifier =
        "sentry-dbid-379053b2-fb33-4a5f-b3d3-dda3ec1dc674"));
  } catch (t) {}
})(),
        ...
        e.create = function (t, e) {
          ...
          return (
            ...
            (function (t, e, n, o) {
              ...
              let E = h.getBestVersionForData(d, n);
              if (!E)
                throw Error(
              ...
              let y = (function (t, e, n) {
                  ...
                  return (function (t, e, n) {
                    ...
                    let a = r.getSymbolTotalCodewords(e),
                      u = a - f.getTotalCodewordsCount(e, n),
      ...
      16130: function (t, e, n) {
        ...
        (e.fromArray = function (t) {
                  ...
                  for (let t = 0; t < u.length; t++) {
                    ...
                    for (let t = 0; t < i.length; t++) {
                      ...
                      n[a] && n[a].node.mode === l.mode
                        ? ((o[a][f] =
                            g(n[a].lastCount + l.length, l.mode) -
                            g(n[a].lastCount, l.mode)),
          ...
          (e.rawSplit = function (t) {
            return e.fromArray(d(t, l.isKanjiModeEnabled()));
          });
      },
      10242: function (t, e) {
        let n;
                ...
                for (let s = 0; s < t.length; s++) {
                  ...
                  l || a || (a = !0),
                    t[s]
                      ? (u++,
                        (s > 0 && l > 0 && t[s - 1]) ||
                          ((r += a ? i("M", l + n, 0.5 + f + n) : i("m", o, 0)),
                          (o = 0),
                          (a = !1)),
                        (l + 1 < e && t[s + 1]) || ((r += i("h", u)), (u = 0)))
                      : o++;
                }
                return r;
              })(s, u, a.margin) +
            ...
            for (let e = 0; e < u; e++)
              for (let n = 0; n < u; n++) {
                ...
                e >= s &&
                  ...
                  (c =
                    l[
                      i[Math.floor((e - s) / a) * o + Math.floor((n - s) / a)]
                        ? 1
                        : 0
                    ]),
                  (t[f++] = c.r),
